...
for r in range(Nr):
    ...
    if r==0:
            ...
            p = lmfit.Parameters()
            p.add_many(('nc', nc[r-1],True,nc[r-1]-deln,nc[r-1]+deln),('ns', ns[r-1],True,ns[r-1]-deln,ns[r-1]+deln), ('Tc_pal', Tc_pal[r-1],True,Tc_pal[r-1]-deltemp,Tc_pal[r-1]+deltemp), ('Tc_per', Tc_per[r-1],True,Tc_per[r-1]-deltemp,Tc_per[r-1]+deltemp), ('Ts_pal', Ts_pal[r-1],True,Ts_pal[r-1]-deltemp,Ts_pal[r-1]+deltemp), ('Ts_per', Ts_per[r-1],True,Ts_per[r-1]-deltemp,Ts_per[r-1]+deltemp), ('Uc',Uc[r-1],True,Uc[r-1]-delU,0),('Us',Us[r-1],True,Us[r-1]-delU,Us[r-1]+delU),('kappac',kappac[r-1],True,2,50),('kappas',kappas[r-1],True,2,50))
