...
for r in range(Nr):
    ...
    plt.text(pal_v[0],-5, r'$v_{Ae}(m/s)=$' "%.0f" % kappas[r], fontsize=8)
    plt.text(pal_v[0],-5.5, r'$\beta_c=$' "%.4f" % kappas[r], fontsize=8)
    plt.text(pal_v[0],-6, r'$\beta_s=$' "%.4f" % kappas[r], fontsize=8)
