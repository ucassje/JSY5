...
def Collision_Core(a,b,r):
    ...
    if (a**2+b**2)**0.5/v_th_function(temperature(r))==0:
            d=(r_s**3)*(n(r)*10**6)/(v_th_function(temperature(r))**3*np.pi**(3/2))*np.exp(-a**2/v_th_function(temperature(r))**2-b**2/v_th_function(temperature(r))**2) #(r_s**3)*(n(r)*10**6)*(np.pi**1.5*v_th_function(temperature(r))**3)**(-1)*(gamma(kappa+1)/(gamma(kappa-0.5)*kappa**1.5))*(1.+((b/v_th_function(temperature(r)))**2)/kappa+((a/v_th_function(temperature(r)))**2)/kappa)**(-kappa-1.)            
    else:
            d=(r_s**3)*(n(r)*10**6)/(v_th_function(temperature(r))**3*np.pi**(3/2))*np.exp(-a**2/v_th_function(temperature(r))**2-b**2/v_th_function(temperature(r))**2) #(r_s**3)*(n(r)*10**6)*(np.pi**1.5*v_th_function(temperature(r))**3)**(-1)*(gamma(kappa+1)/(gamma(kappa-0.5)*kappa**1.5))*(1.+((b/v_th_function(temperature(r)))**2)/kappa+((a/v_th_function(temperature(r)))**2)/kappa)**(-kappa-1.)            
    return d
...
def Collision_Proton(a,b,r):
    ...
    if (a**2+b**2)**0.5/v_th_function_p(temperature(r))==0:
            d=(r_s**3)*(n(r)*10**6)/(v_th_function_p(temperature(r))**3*np.pi**(3/2))*np.exp(-a**2/v_th_function_p(temperature(r))**2-b**2/v_th_function_p(temperature(r))**2) #(r_s**3)*(n(r)*10**6)*(np.pi**1.5*v_th_function_p(temperature(r))**3)**(-1)*(gamma(kappa+1)/(gamma(kappa-0.5)*kappa**1.5))*(1.+((b/v_th_function_p(temperature(r)))**2)/kappa+((a/v_th_function_p(temperature(r)))**2)/kappa)**(-kappa-1.)
    else:
            d=(r_s**3)*(n(r)*10**6)/(v_th_function_p(temperature(r))**3*np.pi**(3/2))*np.exp(-a**2/v_th_function_p(temperature(r))**2-b**2/v_th_function_p(temperature(r))**2) #(r_s**3)*(n(r)*10**6)*(np.pi**1.5*v_th_function_p(temperature(r))**3)**(-1)*(gamma(kappa+1)/(gamma(kappa-0.5)*kappa**1.5))*(1.+((b/v_th_function_p(temperature(r)))**2)/kappa+((a/v_th_function_p(temperature(r)))**2)/kappa)**(-kappa-1.)
    return d
...
def G_per_2e(a,b,r):
    ...
    if (a**2+b**2)**0.5/v_th_function(temperature(r))<1 and (a**2+b**2)**0.5>0:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*((2/(3*v_th_function(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function(temperature(r))**3)-(4/15)*(b**2/v_th_function(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function(temperature(r))**5)+(2/5)*(b**2*(a**2+b**2)/v_th_function(temperature(r))**5))
    elif (a**2+b**2)==0:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*((2/(3*v_th_function(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function(temperature(r))**3)-(4/15)*(b**2/v_th_function(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function(temperature(r))**5)+(2/5)*(b**2*(a**2+b**2)/v_th_function(temperature(r))**5))
    else:
...
def G_per_e(a,b,r):
    ...
    if (a**2+b**2)**0.5/v_th_function(temperature(r))<1 and abs(b)>0:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*(1/b)*((2/(3*v_th_function(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function(temperature(r))**5))
...
def G_per_ee(a,b,r):
    d=0
    if (a**2+b**2)**0.5/v_th_function(temperature(r))<1 and abs(b)==0:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*((2/(3*v_th_function(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function(temperature(r))**3)-(4/15)*(b**2/v_th_function(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function(temperature(r))**5)+(2/5)*(b**2*(a**2+b**2)/v_th_function(temperature(r))**5)) #2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*((2/(3*v_th_function(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function(temperature(r))**5))
    elif (a**2+b**2)**0.5/v_th_function(temperature(r))>=1 and abs(b)==0:
...
def G_pal_2e(a,b,r):
    d=0
    if (a**2+b**2)**0.5/v_th_function(temperature(r))<1 and (a**2+b**2)**0.5>0:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*((2/(3*v_th_function(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function(temperature(r))**3)-(4/15)*(a**2/v_th_function(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function(temperature(r))**5)+(2/5)*(a**2*(a**2+b**2)/v_th_function(temperature(r))**5))
    elif (a**2+b**2)==0:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*((2/(3*v_th_function(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function(temperature(r))**3)-(4/15)*(a**2/v_th_function(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function(temperature(r))**5)+(2/5)*(a**2*(a**2+b**2)/v_th_function(temperature(r))**5))
    else:
...
def G_pal_per_e(a,b,r):
    d=0
    if (a**2+b**2)**0.5/v_th_function(temperature(r))<1 and (a**2+b**2)**0.5>0:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*(-(4/15)*(a*b/v_th_function(temperature(r))**3)+(2/5)*(a*b*(a**2+b**2)/v_th_function(temperature(r))**5))
    elif (a**2+b**2)==0:
        d=0
    else:
        d=(-(r_s**3)*(n(r)*10**6)*v_th_function(temperature(r))**2*(1.5*a*b/(a**2+b**2)**2.5)*((2/np.pi**0.5)*((a**2+b**2)**0.5/v_th_function(temperature(r)))*np.exp(-(a**2+b**2)/v_th_function(temperature(r))**2)+(2*(a**2+b**2)/v_th_function(temperature(r))**2-1)*special.erf((a**2+b**2)**0.5/v_th_function(temperature(r))))+2*(r_s**3)*(n(r)*10**6)*a*b/(a**2+b**2)**1.5*special.erf((a**2+b**2)**0.5/v_th_function(temperature(r))))
    return d
...
def G_per_2p(a,b,r):
    ...
    if (a**2+b**2)**0.5/v_th_function_p(temperature(r))<1:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*((2/(3*v_th_function_p(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function_p(temperature(r))**3)-(4/15)*(b**2/v_th_function_p(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function_p(temperature(r))**5)+(2/5)*(b**2*(a**2+b**2)/v_th_function_p(temperature(r))**5))
    else:
        d=(r_s**3)*(n(r)*10**6)*v_th_function_p(temperature(r))**2*(0.5/(a**2+b**2)**1.5-1.5*b**2/(a**2+b**2)**2.5)*((2/np.pi**0.5)*((a**2+b**2)**0.5/v_th_function_p(temperature(r)))*np.exp(-(a**2+b**2)/v_th_function_p(temperature(r))**2)+(2*(a**2+b**2)/v_th_function_p(temperature(r))**2-1)*special.erf((a**2+b**2)**0.5/v_th_function_p(temperature(r))))+2*(r_s**3)*(n(r)*10**6)*b**2/(a**2+b**2)**1.5*special.erf((a**2+b**2)**0.5/v_th_function_p(temperature(r)))
    return d

def G_per_p(a,b,r):
    d=0
    if (a**2+b**2)**0.5/v_th_function_p(temperature(r))<1 and abs(b)>0:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*(1/b)*((2/(3*v_th_function_p(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function_p(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function_p(temperature(r))**5))
        ...
        d=(r_s**3)*(n(r)*10**6)*v_th_function_p(temperature(r))**2*(1/b)*(0.5/(a**2+b**2)**1.5)*((2/np.pi**0.5)*((a**2+b**2)**0.5/v_th_function_p(temperature(r)))*np.exp(-(a**2+b**2)/v_th_function_p(temperature(r))**2)+(2*(a**2+b**2)/v_th_function_p(temperature(r))**2-1)*special.erf((a**2+b**2)**0.5/v_th_function_p(temperature(r))))
    elif (a**2+b**2)**0.5/v_th_function_p(temperature(r))>=1 and abs(b)==0:
...
def G_per_pp(a,b,r):
    d=0
    if (a**2+b**2)**0.5/v_th_function_p(temperature(r))<1 and abs(b)==0:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*((2/(3*v_th_function_p(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function_p(temperature(r))**3)-(4/15)*(b**2/v_th_function_p(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function_p(temperature(r))**5)+(2/5)*(b**2*(a**2+b**2)/v_th_function_p(temperature(r))**5)) #2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*((2/(3*v_th_function_p(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function_p(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function_p(temperature(r))**5))
    elif (a**2+b**2)**0.5/v_th_function_p(temperature(r))>=1 and abs(b)==0:
...
def G_pal_2p(a,b,r):
    d=0
    if (a**2+b**2)**0.5/v_th_function_p(temperature(r))<1:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*((2/(3*v_th_function_p(temperature(r))))-(2/15)*((a**2+b**2)/v_th_function_p(temperature(r))**3)-(4/15)*(a**2/v_th_function_p(temperature(r))**3)+(1/10)*((a**2+b**2)**2/v_th_function_p(temperature(r))**5)+(2/5)*(a**2*(a**2+b**2)/v_th_function_p(temperature(r))**5))
    else:
        d=(r_s**3)*(n(r)*10**6)*v_th_function_p(temperature(r))**2*(0.5/(a**2+b**2)**1.5-1.5*a**2/(a**2+b**2)**2.5)*((2/np.pi**0.5)*((a**2+b**2)**0.5/v_th_function_p(temperature(r)))*np.exp(-(a**2+b**2)/v_th_function_p(temperature(r))**2)+(2*(a**2+b**2)/v_th_function_p(temperature(r))**2-1)*special.erf((a**2+b**2)**0.5/v_th_function_p(temperature(r))))+2*(r_s**3)*(n(r)*10**6)*a**2/(a**2+b**2)**1.5*special.erf((a**2+b**2)**0.5/v_th_function_p(temperature(r)))
    return d

def G_pal_per_p(a,b,r):
    d=0
    if (a**2+b**2)**0.5/v_th_function_p(temperature(r))<1:
        d=2*(r_s**3)*(n(r)*10**6)/(np.pi**0.5)*(-(4/15)*(a*b/(v_th_function_p(temperature(r)))**3)+(2/5)*(a*b*(a**2+b**2)/(v_th_function_p(temperature(r)))**5))
    else:
        d=(-(r_s**3)*(n(r)*10**6)*v_th_function_p(temperature(r))**2*(1.5*a*b/(a**2+b**2)**2.5)*((2/np.pi**0.5)*((a**2+b**2)**0.5/v_th_function_p(temperature(r)))*np.exp(-(a**2+b**2)/v_th_function_p(temperature(r))**2)+(2*(a**2+b**2)/v_th_function_p(temperature(r))**2-1)*special.erf((a**2+b**2)**0.5/v_th_function_p(temperature(r))))+2*(r_s**3)*(n(r)*10**6)*a*b/(a**2+b**2)**1.5*special.erf((a**2+b**2)**0.5/v_th_function_p(temperature(r))))
    return d

def H_palp(a,b,r):
    d=0
    if (a**2+b**2)**0.5/v_th_function_p(temperature(r))<1:
            d=(r_s**3)*(n(r)*10**6)*(4/np.pi**0.5)*(a/v_th_function_p(temperature(r)))*(-(1/3)*(1/v_th_function_p(temperature(r))**2)+(1/5)*((a**2+b**2)/v_th_function_p(temperature(r))**4))
    else:
            d=(r_s**3)*(n(r)*10**6)*(1/v_th_function_p(temperature(r)))*((2/np.pi**0.5)*(a/(a**2+b**2))*np.exp(-(a**2+b**2)/v_th_function_p(temperature(r))**2)-(a*v_th_function_p(temperature(r)))/(a**2+b**2)**1.5*special.erf((a**2+b**2)**0.5/v_th_function_p(temperature(r))))
    return d

def H_perp(a,b,r):
    d=0
    if (a**2+b**2)**0.5/v_th_function_p(temperature(r))<1:
            d=(r_s**3)*(n(r)*10**6)*(4/np.pi**0.5)*(b/v_th_function_p(temperature(r)))*(-(1/3)*(1/v_th_function_p(temperature(r))**2)+(1/5)*((a**2+b**2)/v_th_function_p(temperature(r))**4))
    else:
            d=(r_s**3)*(n(r)*10**6)*(1/v_th_function_p(temperature(r)))*((2/np.pi**0.5)*(b/(a**2+b**2))*np.exp(-(a**2+b**2)/v_th_function_p(temperature(r))**2)-(b*v_th_function_p(temperature(r)))/(a**2+b**2)**1.5*special.erf((a**2+b**2)**0.5/v_th_function_p(temperature(r))))
    return d
...
def Matrix_A(R,M):
    ...
    for i in range(Nv):
            for j in range(Nv):
                    if R==0:
                            if i==0:
                                    A[i,j] =1+0*rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==0 else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else 0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                            elif i==1:
                                    A[i,j] =-0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1+0*rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==1 else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else 0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                            elif i==Nv-1:
                                    ...
                                    A[i,j] =0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1+0*rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-2 else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                            else:
                                    A[i,j] =0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1+0*rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else 0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                    elif R==Nr-1:
                            if i==0:
                                    A[i,j] =1+rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==0 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                            elif i==1:
                                    A[i,j] =-rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1+rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==1 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                            elif i==Nv-1:
                                    ...
                                    A[i,j] =rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1+rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-2 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                            else:
                                    A[i,j] =rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1+rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                    else:
                            if i==0:
                                    A[i,j] =1+rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))-rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))-rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==0 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                            elif i==1:
...
def Matrix_Q(R,M):
    ...
    for i in range(Nv):
        for j in range(Nv):
                if R==0:
                        if i==0:
                                A[i,j] =1+0*(delt)*(-U_solar(z[R])*dlnB(z[R]))-0*rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+0*(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-0*(delt)*U_solar(z[R])*dcos(z[R])/cos(z[R]) if j==0 else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else -0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                        elif i==1:
                                A[i,j] =0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1+0*(delt)*(-U_solar(z[R])*dlnB(z[R]))-0*rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+0*(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-0*(delt)*U_solar(z[R])*dcos(z[R])/cos(z[R]) if j==1 else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else -0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                        elif i==Nv-1:
                                ...
                                A[i,j] =-0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1+0*(delt)*(-U_solar(z[R])*dlnB(z[R]))-0*rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+0*(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-0*(delt)*U_solar(z[R])*dcos(z[R])/cos(z[R]) if j==Nv-2 else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                        else:
                                A[i,j] =-0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else 0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1+0*(delt)*(-U_solar(z[R])*dlnB(z[R]))-0*rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+0*rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+0*rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+0*(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-0*(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-0*(delt)*U_solar(z[R])*dcos(z[R])/cos(z[R]) if j==i else -0*rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-0*rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-0*rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else -0*rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                elif R==Nr-1:
                        if i==0:
                                A[i,j] =1+(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==0 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                        elif i==1:
                                A[i,j] =rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==0 else 1+(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==1 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==2 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==3 else 0
                        elif i==Nv-1:
                                ...
                                A[i,j] =-rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==Nv-4 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-3 else 1+(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==Nv-2 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==Nv-1 else 0
                        else:
                                A[i,j] =-rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i-2 else rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])+rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))+rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i-1 else 1+(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==i else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==i+1 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==i+2 else 0
                else:
                        if i==0:
                                A[i,j] =1+(delt)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*dlnB(z[R]))-rect_v(per_v[M])*(Fvv/4)*(Col/2*(G_per_ee(pal_v[i],per_v[M],z[R])+G_per_pp(pal_v[i],per_v[M],z[R])))+rect_v(per_v[M])*(Fvv/4)*(-Col/2*(G_per_2e(pal_v[i],per_v[M],z[R])+G_per_2p(pal_v[i],per_v[M],z[R])))+rect_v(pal_v[i])*(Fvv/4)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R])))+(delt)*(4*np.pi*Col)*(Collision_Core(pal_v[i],per_v[M],z[R])+(Me/Mp)*Collision_Proton(pal_v[i],per_v[M],z[R]))-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(2.*delt/z[R])-(delt)*(U_solar(z[R])+pal_v[i]*cos(z[R]))*dcos(z[R])/cos(z[R]) if j==0 else -rect_v(pal_v[i])*(Fv/4)*cos(z[R])*electric(z[R])-rect_v(pal_v[i])*(Fv/4)*(-(U_solar(z[R])+pal_v[i]*cos(z[R]))*(dU_solar(z[R])/cos(z[R])-U_solar(z[R])*dcos(z[R])/(cos(z[R])**2))-(cos(z[R])*dlnB(z[R])*per_v[M]**2/2))-rect_v(pal_v[i])*(Fv/4)*(-Col*H_palp(pal_v[i],per_v[M],z[R])) if j==1 else -rect_v(pal_v[i])*(Fvv/8)*(-Col/2*(G_pal_2e(pal_v[i],per_v[M],z[R])+G_pal_2p(pal_v[i],per_v[M],z[R]))) if j==2 else 0
                        elif i==1:
